    ...
    public class UIShiny : BaseMaterialEffect
    {
       ...
       void Start()
         ...
         void Update()
        {
            ...
            {
                bigBullet.GetComponent<UIShiny>().Play(false);
            }
            else if (powerups.purplePlanetState)
            {
                triBullet.GetComponent<UIShiny>().Play(false);
            }
            else if (powerups.orangePlanetState)
            {
                speed.GetComponent<UIShiny>().Play(false);
            }
            else if (powerups.earthState)
            {
                shield.GetComponent<UIShiny>().Play(false);
            }
